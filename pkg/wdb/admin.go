...
func (wdb wdbClient) createAdminRole() {
	...
	if !roleExists {
		_ = wdb.Roles.Create(model.Identifier(admin.DEFAULT_ADMIN_ROLE), admin.ALLOWED_ADMIN_PRIVILEGES, admin.DENIED_ADMIN_PRIVILEGES, admin.DEFAULT_ADMIN_ROLE_HIDDEN_STATUS)
	}
}
